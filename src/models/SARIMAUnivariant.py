...
class SARIMAModel:
    def __init__(self, file_path, target_column):
        """
        SARIMA model sınıfını başlatır.
    ...
    def train_model(self, train_data, p, d, q, P, D, Q, s):
        """
        SARIMA modelini eğitir.
        :param train_data: Eğitim veri seti
        :param p: SARIMA modelindeki AR bileşeni
        :param d: SARIMA modelindeki fark alma derecesi
        :param q: SARIMA modelindeki MA bileşeni
        :param P, D, Q: Mevsimsel ARIMA parametreleri
        :param s: Mevsimsel dönem (ör. aylık veriler için 12)
